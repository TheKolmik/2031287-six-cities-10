...
import {NearPlaces} from '../../types/coordinates';
import {City} from '../../types/coordinates';
import {useState} from 'react';

type Props = {
  ratings: StarRating [];
  offers: Offer [];
  nearPoints: NearPlaces [];
  city: City;
}
...
function PropertyPage ({ratings, offers, nearPoints, city}: Props): JSX.Element {
  ...
  const handleAddRating = (ratingStar:string) => {
    setRatingStars([...ratingStars, ratingStar]);
  };
        ...
        <div className="container">
          <section className="near-places places">
            ...
            <div className="near-places__list places__list">
              <CardList
              // можно ли записать сюда CardLsit без пропса onCardHover?
              // как сделать чтобы тут показывалось только 3 карточки?
              // вопрос по последниму предложении в последнем задинии 5.18.
                offers={offers}
